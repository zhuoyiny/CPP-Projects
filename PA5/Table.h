...
// add private data and methods here
		...
		ListType *data;   // array of linkedList 

		void initTable();  // initate the table, create an empty list
		int numNonEmpty() const;	// get the number of the non-empty buckets	
		int longestChain() const;   // get the length of the longest chain
